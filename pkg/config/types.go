...
type ClusterConfiguration struct {
	...
	// map: dst = src
	// not saved into kspawn.toml
	Copymap map[string]string `toml:"-"`
...
type BindmountConfiguration struct {
	ReadOnly  map[string]string `toml:"read-only" mapstructure:"read-only"`
	ReadWrite map[string]string `toml:"read-write" mapstructure:"read-write"`
}
